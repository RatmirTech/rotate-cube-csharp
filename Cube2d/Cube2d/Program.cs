...
//Graphics graphics = new Graphics(100, 60, 1);
//var texture = new char[] { '-', ':', 'a', '@' };
//Circle circle = new Circle(new Vector2(0, 0), 1.0f, texture);
//graphics.Begin();
...
Graphics graphics = new Graphics(60, 60, 1);
var texture = new char[] { '-', ':', 'a', '@' };
SolidRectangle rectangle = new SolidRectangle(new Vector2(0, 0), new Vector2(30, 30), texture);
graphics.Begin();
